import { ProjectsList } from "@/components/common/ProjectCard";

export default function Page() {
  return (
    <div className="min-h-screen bg-backLight dark:bg-backDark transition-colors duration-300 bg-zinc-950"  >
